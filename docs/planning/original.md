...
Frozen snapshot of the README's planning/development sections, preserved here for
history. The plan and Anyserver write-up reference a number of sibling repos under
github.com/accretional (some private). Items not yet implemented in the main repo
